Public Class AjoutProduits
    ...
    Private Sub addProduct_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles addProduct.Click
        ...
        If fileUpload.HasFile Then
            Try
                fileUpload.SaveAs("C:\Users\Nico\Desktop\VbFinal\SiteMarchandFinal\SiteMarchandFinal\images\" & prodLib & ".jpg")
        ...
        Dim query As String = " INSERT INTO PRODUCTS(PROD_LIB,PROD_PRIX,PROD_DECRITION,PROD_DESCTECH,PROD_MARQUE,ID_CAT) VALUES('" & prodLib & "','" & prodPrix & "','" & prodDesc & "','" & prodDescrTech & "','" & prodMarque & "','" & varId & "')"
